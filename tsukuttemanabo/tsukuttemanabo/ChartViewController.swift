...
class ChartViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        bottomLabel(uiView, pcrCount, 0.39, 85, text: "22222222", size: 30, weight: .bold, color: colors.blue)
        ...
        for i in 0..<CovidSignleton.shared.prefecture.count {
            if CovidSignleton.shared.prefecture[i].name_ja == "東京" {
                prefecture.text = CovidSignleton.shared.prefecture[i].name_ja
                pcrCount.text = "\(CovidSignleton.shared.prefecture[i].pcr)"
                casesCount.text = "\(CovidSignleton.shared.prefecture[i].cases)"
                deathsCount.text = "\(CovidSignleton.shared.prefecture[i].deaths)"
            }
        }
        ...
        array = CovidSignleton.shared.prefecture
        dataSet()
    }
